...
- [ ] [Comparisons and Hypothesis test](analysis/2.correlation.md). Chi-squared test and T-student test analyses clinical variables to the 'Overall_Survival_Status'. The Hypothesis test evaluates the strength of evidence in supportting the null hypothesis.
