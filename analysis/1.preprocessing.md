...
<!-- # TO DO @PATRICK: function to select variables with unique observations? --> <!-- # kirc_cleanX <- kirc_clean1 %>% --> <!-- #     summarise_if(is.numeric, ~ n=unique(.)) -->
...
![](figs/render-unnamed-chunk-24-1.png)
...
![](figs/render-unnamed-chunk-25-1.png)
...
![](figs/render-unnamed-chunk-26-1.png)
