...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kirc_clinic2 <-}\StringTok{ }\NormalTok{kirc_clinic }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(disease_free_mth }\OperatorTok{>=}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year_diagnose =} \KeywordTok{as.integer}\NormalTok{(year_diagnose))}
