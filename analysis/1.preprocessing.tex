...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kirc_clean2 }\OperatorTok{%>%}
\StringTok{     }\KeywordTok{select_if}\NormalTok{(is.character) }\OperatorTok{%>%}
\StringTok{     }\KeywordTok{skim}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# droping levels ??? What about others?? }
\CommentTok{# check chunk bellow!}
\NormalTok{kirc_clinic <-}\StringTok{ }\NormalTok{kirc_clinic }\OperatorTok{%>%}
\StringTok{     }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{race =} \KeywordTok{fct_recode}\NormalTok{(race, }\DataTypeTok{NULL =} \StringTok{'ASIAN'}\NormalTok{))}

\CommentTok{# kirc_clinic <- kirc_clinic %>%}
\CommentTok{#     mutate(race = fct_drop(race, only = 'ASIAN'))}
